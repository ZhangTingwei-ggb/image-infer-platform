...
python run_infer_wsi.py \
    --model=pretrained_weights/resnet34_cerberus \
    --nr_inference_workers=4 \
    --nr_post_proc_workers=8 \
    --batch_size=25 \
    --cache_path=/home/linjiatai \
    --logging_dir=logging \
    --input_dir=infer_dataset/input_wsi/test2 \
    --msk_dir=infer_dataset/input_masks/test2 \
    --output_dir=infer_dataset/output_wsi/test2 \
    --save_thumb \
    --save_mask
...
Options:
  ...
  --tile_shape=<n>            Tile size (px) for nuclei post-processing. [default: 4096]
  --chunk_shape=<n>           Tile size (px) for network inference. [default: 15000]
